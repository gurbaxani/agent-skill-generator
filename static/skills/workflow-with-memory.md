...
description: "> The same startup MVP workflow from workflow-startup-mvp.md, but with an MCP memory server handling state between agents. No more copy-paste handoffs."
license: "MIT"
author: "@msitarzewski"
tags:
  - "examples"
