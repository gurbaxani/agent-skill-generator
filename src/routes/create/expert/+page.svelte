...
Do NOT include any markdown formatting around the JSON except standard \`\`\`json blocks if needed, but output ONLY the raw JSON. Output no other conversational text.`;
			...
			const parsed = extractAndParseJson<AIGeneratedSkill>(responseText);
		...
		<div class="sticky-column">
			<div class="flex flex-col gap-4">
				...
				<div class="flex flex-col gap-3">
					...
					{#if publishUrl}
						<div
							class="cyber-panel mt-3 p-4 text-center"
							style="background: var(--surface-sunken); border-color: var(--accent); width: 100%;"
						>
